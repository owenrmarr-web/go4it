...
import redeployPreviewTemplateRoute from "./routes/redeploy-preview-template.js";
import uploadSourceRoute from "./routes/upload-source.js";
...
const PROTECTED_PATHS = new Set(["generate", "iterate", "deploy", "deploy-preview", "redeploy-preview-template", "preview", "workspace", "secrets", "machines", "cancel", "upload-source"]);
...
app.register(machinesRoute);
app.register(redeployPreviewTemplateRoute);
app.register(uploadSourceRoute);
