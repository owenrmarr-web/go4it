...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-inset flex items-center justify-center px-4">
      <div className="max-w-sm w-full bg-surface rounded-xl shadow-sm border border-border-subtle p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          {isSignUp && (
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg border border-input-border bg-input-bg text-text-secondary focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent"
            />
          )}
          <input
            type="email"
