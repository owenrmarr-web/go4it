  ...
  return (
    <div className="min-h-screen bg-page flex items-center justify-center px-4">
      <div className="max-w-sm w-full bg-card rounded-xl shadow-sm border border-edge p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          {isSignUp && (
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg border border-edge-strong bg-input-bg text-fg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent"
            />
          )}
          <input
            type="email"
        ...
        <div className="mt-4 text-center text-xs text-fg-dim">
